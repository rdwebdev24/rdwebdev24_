...
<div class="modal_info">
  ...
  },
  {
    id: 2,
    info: `<div>
     <img src="../assets/images/game1.avif" alt="">
</div>
...
<div class="modal_info">
     ...
     <div style="display:flex;gap:1rem;">
          <button class="modal_btn "><a href="https://github.com/rdwebdev24?tab=repositories" target="_blank">github</a></button>
          <button class="modal_btn "><a href="https://www.youtube.com/watch?v=uN4yKps3tKc" target="_blank">live demo</a></button>
     </div>
</div>`,
  },
  {
...
<h3>Student engagement detection</h3>
<div class="modal_info">
